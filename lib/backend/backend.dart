...
import 'schema/selected_foods_record.dart';
...
export 'schema/selected_foods_record.dart';
...
/// Functions to query SelectedFoodsRecords (as a Stream and as a Future).
Future<int> querySelectedFoodsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      SelectedFoodsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<SelectedFoodsRecord>> querySelectedFoodsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      SelectedFoodsRecord.collection,
      SelectedFoodsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<SelectedFoodsRecord>> querySelectedFoodsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>

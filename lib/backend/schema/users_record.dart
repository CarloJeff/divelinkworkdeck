...
class UsersRecord extends FirestoreRecord {
  ...
  // "selectedOrders" field.
  String? _selectedOrders;
  String get selectedOrders => _selectedOrders ?? '';
  bool hasSelectedOrders() => _selectedOrders != null;
  ...
  void _initializeFields() {
    ...
    _selectedOrders = snapshotData['selectedOrders'] as String?;
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.selectedOrders == e2?.selectedOrders;
  }
